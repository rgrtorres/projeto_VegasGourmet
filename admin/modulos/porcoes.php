...
if($inserir) {
	if($acao == "insere") {
		$conexao->conectar()->query("INSERT INTO cardapio_site (item_cardapio, acompanhamento_item_cardapio, preco_item_cardapio, categoria_item_cardapio) VALUES ('{$item}', '{$acompanhamento}', '{$preco}', 'Porcao')");
...
<form action="" method="POST">
	...
	<input type="text" class="input-normal" name="item" placeholder="Nome da Porção" required>
...
<form action="" method="POST">
	...
	<input type="text" class="input-normal" name="item" placeholder="Nome da Porção" value="<?php echo $consulta['item_cardapio']; ?>" required>
