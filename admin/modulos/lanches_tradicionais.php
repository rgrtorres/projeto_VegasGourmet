...
if($inserir) {
	if($acao == "insere") {
		$conexao->conectar()->query("INSERT INTO cardapio_site (item_cardapio, acompanhamento_item_cardapio, preco_item_cardapio, categoria_item_cardapio) VALUES ('{$item}', '{$acompanhamento}', '{$preco}', 'LancheT')");
